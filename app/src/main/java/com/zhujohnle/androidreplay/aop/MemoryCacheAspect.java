...
import com.zhujohnle.androidreplay.utils.LogUtils;
import com.zhujohnle.androidreplay.utils.MemoryCacheManager;
...
public class MemoryCacheAspect {
    ...
    @Pointcut("execution(@com.zhujohnle.annotation.aspect.MemoryCache * *(..))")//方法切入点
